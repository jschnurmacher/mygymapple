...
namespace MyGym
{
    ...
    public partial class AccountSocksBilling : ContentPage
    {
        public AccountSocksBilling()
        {
            InitializeComponent();
        }
        ...
        async private void AddBilling_Tapped(object sender, EventArgs e)
        {
            ...
            await Shell.Current.Navigation.PushAsync(new AccountSocksBillingEdit());
        }
        ...
        async private void Continue_Clicked(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    await Shell.Current.Navigation.PushAsync(new AccountSocksSummary());
                }
            }
        }
    }
